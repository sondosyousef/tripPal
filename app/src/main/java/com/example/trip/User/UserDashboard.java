...
public class UserDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array){
        ...
        recyclerViewadapter = new FeaturedAdpater(GetDataAdapter1, this);
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL2(JSONArray array){
        ...
        recyclerViewadapter2 = new MostAdapter(GetMostAdapter2, this);

        mostViewRecycler.setAdapter(recyclerViewadapter2);
    }
